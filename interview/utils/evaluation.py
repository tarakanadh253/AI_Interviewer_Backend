...
def calculate_semantic_similarity(user_answer: str, ideal_answer: str) -> float:
    ...
    logger.error("NLP model not available - this should not happen!")
    raise RuntimeError("NLP model is required but not available. Please ensure sentence-transformers is installed and working.")
